...
import { useShopDetail } from "@/features/customer-booking/hooks/use-shop-detail";
 ...
 * slots.
 *
 * Both queries live here too, so each tab is only offered by a shop that
 * actually runs that programme (decision 36). A shop with neither renders
