...
## ২. নতুন কনফার্মড সিদ্ধান্ত (২৭–৩৭)
...
37. **(Sprint 1) দুই মডেলের ট্রানজিশনে চলতি ব্যবসা কেড়ে নেওয়া হবে না।** আজ যে পার্লার
    লাইভ সিরিয়ালে বাস্তব কাস্টমার সামলাচ্ছে, তার বোর্ড "শীঘ্রই আসছে" দিয়ে বদলে দিলে তার
    দোকান আমরা বন্ধ করে দিলাম। তাই পার্লারের **ডিফল্ট ভিউ** অ্যাপয়েন্টমেন্ট-হোম, কিন্তু
    লাইভ সিরিয়াল একই পাতায় দ্বিতীয় ট্যাবে পুরোপুরি চালু থাকে। অ্যাপয়েন্টমেন্ট ইঞ্জিন
    (Sprint 4–5) লাইভে ওঠার পর ট্যাবটা তোলা হবে।
...
- [x] `src/lib/business-model.ts` — `bookingModel()` রেজলভার (সিদ্ধান্ত ২৭) + ৫টা ইউনিট টেস্ট
- [x] ~~`src/lib/terms.ts` তৈরি~~ → **বিদ্যমান `src/lib/business-terms.ts` বাড়ানো হয়েছে**
      (`board` টার্ম যোগ) + ৭টা ইউনিট টেস্ট — §১.৫-এর সংশোধন দেখো
...
- [x] রিগ্রেশন: সেলুনের রেন্ডার পাথ অপরিবর্তিত; সাইডবার লেবেল অক্ষরে অক্ষরে এক
      (টেস্টে লক করা)
- [x] build ✅ · lint ✅ (বেসলাইনের সমান) · test ✅ ২৩৮টা · ডক আপডেট ✅
- [ ] **মাইগ্রেশন ভেরিফাইড** — ইউজারকে `20260916` SQL এডিটরে চালাতে হবে
...
- [ ] **সার্ভিস ফর্মে ক্যাটাগরি পিকার ফিরিয়ে আনা** (এখন কোনো পিকার নেই, সব সার্ভিস
      `"OTHER"`) — Sprint 1 থেকে সরানো, নিচের আইটেমের পূর্বশর্ত
- [ ] পার্লার ক্যাটাগরি (থ্রেডিং, ওয়্যাক্সিং, মেহেদি, মেকআপ, নেইল) + `business_type` ট্যাগ;
      `services.category`-র CHECK কনস্ট্রেইন্ট চওড়া করার মাইগ্রেশন। DB টেবিল না কোড-লেভেল
      তালিকা — সেটা তখন ঠিক হবে, কারণ আইকন ম্যাপ যেভাবেই হোক কোডে থাকবে
...
- [ ] `DEVELOPMENT.md`-এ ফেজ ৬-এর সারাংশ ও সিদ্ধান্ত ২৭–৩৭ যোগ
- [ ] build ✅ · lint ✅ · test ✅ · ডক আপডেট ✅
